export const ARCANA_DEFINITIONS = [
  ...
  },
  {
    ...
    rarity: 'rare',
    category: 'offense',
    description: 'Your rook deals damage to up to 2 pieces in a row when moving.',
    visual: { particles: true, animation: true, cutscene: false },
  ...
  },
  {
    ...
    rarity: 'rare',
    category: 'utility',
    description: 'Select a square to mark it as cursed - any piece that lands there is destroyed (lasts 1 turn).',
    visual: { particles: true, animation: true, cutscene: false },
