export const ARCANA_DEFINITIONS = [
  ...
  },
  {
    ...
    rarity: '???',
    category: 'special',
    description: 'Target an enemy non-king piece: destroy it. Adjacent enemy non-king pieces are pushed 1 square directly away if possible, and each has a 50% chance to die from the shockwave.',
    visual: { particles: true, animation: true, cutscene: true },
