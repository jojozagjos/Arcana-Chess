export const ARCANA_DEFINITIONS = [
  ...
  },
  {
    ...
    rarity: 'legendary',
    category: 'defense',
    description: 'Activate to protect yourself. When you enter check, a pawn spawns from heaven to block the attack.',
  ...
  },
  {
    ...
    rarity: 'legendary',
    category: 'offense',
    description: 'Select an enemy piece to execute with a falling blade, destroying it in a burst of blood.',
    visual: { particles: true, animation: true, cutscene: true },
  ...
  },
  {
    ...
    rarity: 'legendary',
    category: 'transformation',
    description: 'Select a pawn to strike with divine light and promote it to a queen. The world turns monochrome and you gain 2 consecutive moves.',
    visual: { particles: true, animation: true, cutscene: true },
  ...
  },
  {
    ...
    rarity: 'legendary',
    category: 'utility',
    description: 'Rewind time! The board rises into the sky as the last two moves reverse in monochrome, then color rushes back in.',
    visual: { particles: true, animation: true, cutscene: true },
  ...
  },
  {
    ...
    rarity: 'legendary',
    category: 'utility',
    description: 'Select an enemy piece to seize control of it (turns purple). You can only move this piece next, opponent gets purple vignette. Cannot capture the king.',
    visual: { particles: true, animation: true, cutscene: false },
